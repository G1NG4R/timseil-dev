...
const insertMetricSnapshot = `-- name: InsertMetricSnapshot :execrows
...
func (q *Queries) InsertMetricSnapshot(ctx context.Context, arg InsertMetricSnapshotParams) (int64, error) {
	result, err := q.db.Exec(ctx, insertMetricSnapshot,
		arg.SystemID,
		arg.MeasuredAt,
		arg.P95Ms,
		arg.ErrorRate,
