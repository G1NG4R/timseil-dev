...
//
// H7 REPLACES this file. Nothing here is a decision about the page.
...
// and takes a while to be talked out of it. H7 fills the page and deletes
...
export async function generateMetadata({ params }: PageProps<"/[lang]/about">): Promise<Metadata> {
  ...
  return { alternates: alternatesFor(asLocale(lang), "/about"), robots: { index: false } };
}

export default function Page() {
  return <p>ABOUT [SOON]</p>;
}
