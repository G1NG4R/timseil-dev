...
// `LOG [SOON]` files that away as what this site has to say on the subject,
// and takes a while to be talked out of it. H9 fills the page and deletes
...
export async function generateMetadata({ params }: PageProps<"/[lang]/blog">): Promise<Metadata> {
  ...
  return { alternates: alternatesFor(asLocale(lang), "/blog"), robots: { index: false } };
}
