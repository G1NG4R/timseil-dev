...
// `CONTACT [SOON]` files that away as what this site has to say on the subject,
// and takes a while to be talked out of it. H8 fills the page and deletes
...
export async function generateMetadata({ params }: PageProps<"/[lang]/contact">): Promise<Metadata> {
  ...
  return { alternates: alternatesFor(asLocale(lang), "/contact"), robots: { index: false } };
}

export default function Page() {
  return <p>CONTACT [SOON]</p>;
}
